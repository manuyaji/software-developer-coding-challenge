...
public class TradeRevIllegalStateException extends TradeRevRuntimeException{
	...
	public TradeRevIllegalStateException(ResponseMetadata responseMetadata, ErrorCode errorCode,
	...
	public TradeRevIllegalStateException(Throwable cause, ErrorCode errorCode, Object... errorCodeParams) {
		super(cause, errorCode, errorCodeParams);
	}

	public TradeRevIllegalStateException(Throwable cause, ResponseMetadata responseMetadata, ErrorCode errorCode,
			Object... errorCodeParams) {
