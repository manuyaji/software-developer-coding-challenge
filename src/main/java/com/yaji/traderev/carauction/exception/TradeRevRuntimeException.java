...
public class TradeRevRuntimeException extends RuntimeException {
  ...
  public TradeRevRuntimeException(Throwable cause, ResponseMetadata responseMetadata, ErrorCode errorCode, Object... errorCodeParams) {
	  super(cause);
    this.errorCode = errorCode;
    this.errorCodeParams = errorCodeParams;
  }

  public TradeRevRuntimeException(ResponseMetadata responseMetadata, ErrorCode errorCode, Object... errorCodeParams) {
    this.errorCode = errorCode;
    this.errorCodeParams = errorCodeParams;
  }
}
